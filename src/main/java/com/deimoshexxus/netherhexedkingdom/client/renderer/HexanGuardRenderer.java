...
public class HexanGuardRenderer extends HumanoidMobRenderer<HexanGuardEntity, HexanGuardModel<HexanGuardEntity>> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(NetherHexedKingdom.MODID,
