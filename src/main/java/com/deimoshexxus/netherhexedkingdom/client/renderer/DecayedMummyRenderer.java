...
public class DecayedMummyRenderer extends MobRenderer<DecayedZombieHuskEntity, ZombieModel<DecayedZombieHuskEntity>> {

    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(NetherHexedKingdom.MODID, "textures/entity/zombie/decayed_mummy.png");

    public DecayedMummyRenderer(EntityRendererProvider.Context ctx) {
