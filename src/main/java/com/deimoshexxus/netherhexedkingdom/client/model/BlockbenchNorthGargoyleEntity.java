...
//
//		PartDefinition gargoyle_model = partdefinition.addOrReplaceChild("gargoyle_model", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.0F, 17.0F, 2.0F, 0.0F, 3.1416F, 0.0F));
//
...
//
//		PartDefinition rightWing = gargoyle_model.addOrReplaceChild("rightWing", CubeListBuilder.create(), PartPose.offset(1.0F, -3.0F, -4.0F));
//
...
//
//		PartDefinition leftWing = gargoyle_model.addOrReplaceChild("leftWing", CubeListBuilder.create(), PartPose.offset(-7.0F, -3.0F, -4.0F));
//
