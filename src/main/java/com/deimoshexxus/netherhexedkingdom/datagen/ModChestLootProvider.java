                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(Items.NETHER_BRICK).setWeight(24))
                                        .add(LootItem.lootTableItem(Items.NETHER_BRICK).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 24))))
                                        .add(LootItem.lootTableItem(Items.NETHER_BRICKS).apply(SetItemCountFunction.setCount(UniformGenerator.between(12, 24))))
                                        .add(LootItem.lootTableItem(Items.HONEY_BOTTLE).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
                                        .add(LootItem.lootTableItem(ModItems.MILITUS_ALLOY_NUGGET).setWeight(10))
                                        .add(LootItem.lootTableItem(ModItems.MILITUS_ALLOY_INGOT).setWeight(10))
                                        ...
                                        .add(LootItem.lootTableItem(Items.BLAZE_ROD).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(3, 7))))
                                        .add(LootItem.lootTableItem(Items.SUSPICIOUS_STEW).setWeight(4))
                                        .add(LootItem.lootTableItem(Items.COOKIE).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 6))))
                                        ...
                                        .add(LootItem.lootTableItem(ModItems.IMPERIAL_COINS).setWeight(8).apply(SetItemCountFunction.setCount(UniformGenerator.between(9, 24))))
                                        ...
                                        .add(LootItem.lootTableItem(ModItems.NETHER_PORTAL_ORB).setWeight(2))
                ...
                LootTable.lootTable()
                        .withPool(
                                LootPool.lootPool()
                                        ...
                                        .add(LootItem.lootTableItem(ModItems.ETERNAL_LIGHT_BLOCK_ITEM).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(2, 3))))
                                        .add(LootItem.lootTableItem(ModItems.NETHERITE_OXIDE).setWeight(3))
                                        .add(LootItem.lootTableItem(Items.TIPPED_ARROW).setWeight(10).apply(SetItemCountFunction.setCount(UniformGenerator.between(8, 16)))
