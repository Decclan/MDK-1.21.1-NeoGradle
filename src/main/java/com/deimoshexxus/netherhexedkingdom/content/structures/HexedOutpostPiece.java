...
public class HexedOutpostPiece extends TemplateStructurePiece {

    // Runtime constructor (worldgen)
    public HexedOutpostPiece(
        ...
        super(
                ModStructurePieces.HEXED_OUTPOST_PIECE.get(),
                genDepth,
                templateManager,
                templateId,
                templateId.toString(),
    ...
    public HexedOutpostPiece(
        ...
        super(
                ...
                HexedOutpostPiece::makeSettingsFromTemplate
        );
    }
