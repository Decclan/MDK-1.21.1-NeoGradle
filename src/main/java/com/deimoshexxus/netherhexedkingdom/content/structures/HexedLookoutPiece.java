...
public class HexedLookoutPiece extends TemplateStructurePiece {

    // Runtime constructor (worldgen)
    public HexedLookoutPiece(
        ...
        super(
                ModStructurePieces.HEXED_LOOKOUT_PIECE.get(),
                genDepth,
                templateManager,
                templateId,
                templateId.toString(),
    ...
    public HexedLookoutPiece(
        ...
        super(
                ...
                HexedLookoutPiece::makeSettingsFromTemplate
        );
    }
