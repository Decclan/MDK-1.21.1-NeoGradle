...
public class CrimsonMotherFungusPiece extends TemplateStructurePiece {

    // Runtime constructor (worldgen)
    public CrimsonMotherFungusPiece(
        ...
        super(
                ModStructurePieces.CRIMSON_MOTHER_FUNGUS_PIECE.get(),
                genDepth,
                templateManager,
                templateId,
                templateId.toString(),
    ...
    public CrimsonMotherFungusPiece(
        ...
        super(
                ...
                CrimsonMotherFungusPiece::makeSettingsFromTemplate
        );
    }
