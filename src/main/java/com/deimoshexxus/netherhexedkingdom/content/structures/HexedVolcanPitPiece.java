...
public class HexedVolcanPitPiece extends TemplateStructurePiece {

    // Runtime constructor (worldgen)
    public HexedVolcanPitPiece(
        ...
        super(
                ModStructurePieces.HEXED_VOLCAN_PIT_PIECE.get(),
                genDepth,
                templateManager,
                templateId,
                templateId.toString(),
    ...
    public HexedVolcanPitPiece(
        ...
        super(
                ...
                HexedVolcanPitPiece::makeSettingsFromTemplate
        );
    }
