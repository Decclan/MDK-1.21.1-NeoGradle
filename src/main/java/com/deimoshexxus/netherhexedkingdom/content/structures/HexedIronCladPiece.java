...
public class HexedIronCladPiece extends TemplateStructurePiece {

    // Runtime constructor (worldgen)
    public HexedIronCladPiece(
        ...
        super(
                ModStructurePieces.HEXED_IRON_CLAD_PIECE.get(),
                genDepth,
                templateManager,
                templateId,
                templateId.toString(),
    ...
    public HexedIronCladPiece(
        ...
        super(
                ...
                HexedIronCladPiece::makeSettingsFromTemplate
        );
    }
